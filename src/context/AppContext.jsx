...
export const MOCK_EVENTS = [
  {
    id: 1, name: 'Concierto Rock en Grande', client: 'Producciones XYZ',
    venue: 'Foro Sol, CDMX', date: addDays(today, 5),
    setupDate: addDays(today, 4), teardownDate: addDays(today, 6),
    expectedAttendance: 45000, status: 'confirmed', type: 'concert',
    assignedPersonnel: [1, 2, 3], notes: 'Requiere 2 ambulancias y equipo completo', ambulances: 2,
  },
  {
    id: 2, name: 'Partido Clásico Nacional', client: 'Liga MX',
    venue: 'Estadio Azteca, CDMX', date: addDays(today, 12),
    setupDate: addDays(today, 12), teardownDate: addDays(today, 12),
    expectedAttendance: 80000, status: 'confirmed', type: 'sports',
    assignedPersonnel: [1, 4, 5], notes: 'Evento de alto riesgo, coordinación con seguridad', ambulances: 3,
  },
  {
    id: 3, name: 'Foro Empresarial Tech', client: 'Grupo Empresarial Norte',
    venue: 'Centro Banamex, CDMX', date: subDays(today, 3),
    setupDate: subDays(today, 4), teardownDate: subDays(today, 3),
    expectedAttendance: 5000, status: 'completed', type: 'forum',
    assignedPersonnel: [2, 3], notes: 'Evento corporativo, riesgo bajo', ambulances: 1,
  },
  {
    id: 4, name: 'Festival de Verano', client: 'Eventos del Valle',
    venue: 'Parque Bicentenario', date: addDays(today, 20),
    setupDate: addDays(today, 18), teardownDate: addDays(today, 22),
    expectedAttendance: 15000, status: 'pending', type: 'festival',
    assignedPersonnel: [], notes: 'Pendiente de cotización y asignación', ambulances: 1,
  },
];
...
export const MOCK_PATIENTS = [
  {
    id: 1, folio: 'QA-2024-001', eventId: 3, eventName: 'Foro Empresarial Tech',
    date: subDays(today, 3), patientName: 'Anónimo', age: 34, gender: 'M', reason: 'Lipotimia',
    vitals: { bp: '110/70', hr: 88, spo2: 97, temp: 36.5, rr: 16 },
    treatment: 'Reposo, hidratación oral, observación 30 min',
    transport: false, outcome: 'Dado de alta en sitio', attendedBy: 'Dr. Andrés López', status: 'closed',
  },
  {
    id: 2, folio: 'QA-2024-002', eventId: 3, eventName: 'Foro Empresarial Tech',
    date: subDays(today, 3), patientName: 'Anónimo', age: 58, gender: 'F', reason: 'Crisis hipertensiva',
    vitals: { bp: '180/110', hr: 95, spo2: 96, temp: 36.8, rr: 20 },
    treatment: 'Medicamento antihipertensivo, monitoreo continuo',
    transport: true, transportUnit: 'Ambulancia QA-01', hospital: 'Hospital Ángeles Pedregal',
    outcome: 'Trasladada a hospital', attendedBy: 'Dr. Andrés López', status: 'closed',
  },
];
...
export function AppProvider({ children }) {
  ...
  // availData compartido: { [dateKey]: { [userId]: { type, shifts?, from?, to? } } }
